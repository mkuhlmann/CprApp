<template>
	<div class="flex items-center gap-2 text-sm opacity-50 flex-col md:flex-row">
		<div class="flex items-center">
			<img width="32" height="32" class="mr-1" src="/logo.svg" alt="CPR Timer" /> CprApp
		</div>
		...
		<div class="hidden md:block">&mdash;</div>
		<a href="https://forms.gle/pXJeNPz7413752M28" target="_blank" class="link">Feedback / Suggestions?</a>
	</div>
</template>